...
const Login = () => {
  return (
<div class="font-[sans-serif] bg-gradient-to-r from-white via-white to-white text-[#333]">
      <div class="min-h-screen flex fle-col items-center justify-center lg:p-6 p-4">
        <div class="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
          <div class="max-md:text-center">
            ...
            <p class="text-sm mt-6 text-black">Sign in for full access</p>
            <p class="text-sm mt-10 text-black">Don't have an account <a href="javascript:void(0);" class="text-blsck font-semibold underline ml-1">Register here</a></p>
          </div>
          <form class="bg-gray-300 rounded-xl px-6 py-8 space-y-6 max-w-md md:ml-auto max-md:mx-auto w-full">
